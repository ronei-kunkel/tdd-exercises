...
class HappyHandlerTest extends TestCase
{
  public function test_deve_retornar_false_se_o_input_não_for_instancia_de_Contentable(): void
  {
    ...
    $handler = new HappyHandler($valuableMock, $IntCheckerMock);
  ...
  public function test_se_for_um_happy_e_o_resultado_da_verificação_for_negativo_não_deve_modificar_o_input():void 
  {
    $valuableMock = $this->createMock(Valuable::class);
    $IntCheckerMock = $this->createMock(IntChecker::class);
  ...
  public function test_se_for_um_happy_e_o_resultado_da_verificação_for_positivo_deve_modificar_o_input():void 
  {
    $valuableMock = $this->createMock(Valuable::class);
    $IntCheckerMock = $this->createMock(IntChecker::class);
